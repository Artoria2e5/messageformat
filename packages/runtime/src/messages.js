 ...
 *
 * @param {object} msgData A map of locale codes to their function objects
 * @param {string} [defaultLocale] If not defined, default and initial locale is the first entry of `locales`
 *
 * @example
 * ```js
 * // build.js
...
class Messages {
   ...
   * @readonly
   * @memberof module:messageformat-runtime/messages
   * @instance
